...
class NodeHtmlMarkdown {
    constructor(options, customTranslators) {
        var _a, _b, _c, _d;
        ...
        ignoredElements === null || ignoredElements === void 0 ? void 0 : ignoredElements.forEach(el => this.translators.set(el, { ignore: true, recurse: false }));
        blockElements === null || blockElements === void 0 ? void 0 : blockElements.forEach(el => this.translators.set(el, { surroundingNewlines: 2 }));
    ...
    static translate(htmlOrFiles, opt, trans) {
