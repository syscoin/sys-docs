...
**BitcoinDA's design is based on PoDA (proof of data availability), which is a separation of concerns between data availability and data archiving with the protocol's purpose being the former.**
