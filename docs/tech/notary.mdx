...
Note: The example below uses Syscoin Core RPCs. In the future, many Syscoin-specific RPCs in Syscoin Core (e.g. those for asset management like `assetnew`) will become deprecated in favor of [syscoinjs-lib](https://github.com/syscoin/syscoinjs-lib) and [syscointx-js](https://github.com/syscoin/syscointx-js). We encourage our community to learn those newer, more useful tools for creating/managing assets. 
