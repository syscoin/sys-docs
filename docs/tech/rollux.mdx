...
Rollux is a suite of rollup-based Layer 2 solutions designed to enable EVM users with near-instant low-cost transfers, executions, and contract deployments. Designed to utilize Syscoin's [settlement layer](/docs/intro/syscoin-what#settlement-layer), Rollux solutions provide the lowest cost, highest throughput and most proven Layer 1 security among rollup solutions.  Rollups just work better on Syscoin, and for clear reasons.
