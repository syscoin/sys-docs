...
|             Gas Cost Sampling of Rollux optimistic testnet                                              |
| :--------------------------------------------|----------------------------------------------------------|
|Deployment of Uniswap-based factory contract  |0.009492385026578678 SYS                                  |
|Deployment of PSYS token contract             |0.008709672524387083 SYS                                  |
|Simple token mint                             |0.000083988000503928 SYS                                  |
|Simple token value transfer                   |0.000251126001004504 SYS                                  |
|Simple SYS (native coin) value transfer       |0.000031500000168000 SYS                                  |

|             Estimated Throughput                                                                        |
| :------------------------------|------------------------------------------------------------------------|
|Contract calls                  |1000-3000 Tp/s                                                           |
|Transfers                       |3000-7000 Tp/s                                                           |
...
A. The timing of settlement depends on network activity. The batch of transactions must add up to at least 120kb in order to be committed to the settlement layer. At a minimal rate of traffic (one transaction every two minutes), settlement would occur every 45-60 minutes on average. More activity on the rollup brings faster settlement, to a max rate of once every 2.5 minutes.