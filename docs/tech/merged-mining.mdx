...
For more information or to set up your miner(s) to merge-mine Syscoin, refer to the [Merged Mining Setup Guide](http://localhost:3000/docs/guides/mining_setup).
