...
| Network             |                                                        |
| :------------------ | ------------------------------------------------------ |
| Syscoin Mainnet     | <AddNetworkComponent network={'Mainnet'}/>             |
| Tanenbaum Testnet   | <AddNetworkComponent network={'Tanenbaum Testnet'}/>   |
