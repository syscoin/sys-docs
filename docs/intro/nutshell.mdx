...
An open source community dedicated to developing technology that scales Bitcoin's proof-of-work security to meet global needs and emerging use-cases, while staying aligned with Bitcoin's ideals as much as possible.
