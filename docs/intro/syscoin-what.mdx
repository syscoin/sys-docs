...
- [*Masternodes*](/docs/tech/masternodes) - incentivized full nodes collectively provide [finality](/docs/tech/finality) through multi-quorum chainlocks as additive security and finality on top of Nakamoto consensus. Owners of these collateralized nodes receive rewards for the services they provide to the network.
