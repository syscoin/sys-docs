...
- [**PoDA**](/docs/tech/poda) - Proof of Data Availability is an L1 DA protocol for rollups. It is hash-based and built on UTXO. Efficient, hash-based, general purpose, and easy to integrate.
