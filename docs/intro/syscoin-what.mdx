...
- [**Sentry Nodes and Finality**](/docs/tech/sentrynodes) - Incentivized full nodes deterministically provide [finality](/docs/tech/finality) through multi-quorum chainlocks (4 x 400) as additive security on top of Bitcoin's PoW. Owners of these collateralized nodes receive rewards, including seniority benefits, for the services they provide to the network.
