...
After connecting to the Syscoin Mainnet or Tanenbaum Testnet with MetaMask ([tutorial here](https://syscoin.medium.com/setting-up-metamask-for-syscoin-testnet-nevm-tanenbaum-e2bba17ff309)), head to either one of the below to get some SYS or tSYS as you require, this guide assumes tSYS but applies to Mainnet (SYS) as well:
