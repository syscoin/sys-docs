...
You can add the Syscoin networks to MetaMask using the table below. If this doesn't work for any reason you can either follow the first guide to use [chainlist.org](https://chainlist.org/), or you can enter the information manually further down the page. Welcome to Syscoin!
