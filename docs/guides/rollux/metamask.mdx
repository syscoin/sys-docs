...
> **Transactions on Rollux OPv1 Testnet require test rSYS which will be used as a gas fee.**
...
(if you need more tSYS than the faucet provides, please reach-out to your Syscoin contact(s))
...
Switch your network to Rollux OPv1 Testnet in MetaMask to see your rSYS balance and begin using the network.
 
> **A user-interface for this bridge is nearing completion and will be available soon.**
