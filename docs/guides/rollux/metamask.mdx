...
> **Transactions on Rollux OPv1 Testnet require Test RSYS which is used for gas.**  A bridge to transfer SYS to Rollux as RSYS will become available shortly. Until then, you can request Test RSYS and more OPv1 details by using the [**sign-up form**](https://syscoin.org/rollux).  