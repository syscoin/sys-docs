...
# Sentry Node Setup Guide

### EACH SENTRY NODE MUST HAVE THE FOLLOWING
...
[Sentry Node Install Guide](https://www.youtube.com/watch?v=pOwcFMP92hY)
...
Open a text editor such as notepad ++ to prepare this command or head to [SysHub Sentry Node Registration](https://syshub-dev.web.app/masternodes/masternode-registration).
