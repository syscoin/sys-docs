...
You can compare the Bitcoin and Syscoin hashrates to calculate the live percentage of hashrate shared with Syscoin:

- [Syscoin Hashrate](https://minerstat.com/coin/SYS/network-hashrate)
- [Bitcoin Hashrate](https://minerstat.com/coin/BTC/network-hashrate)
