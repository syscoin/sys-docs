...
![img](https://miro.medium.com/max/700/0*HLHF1f9mOdic1P2R.png)

## Create a MetaMask Wallet or Import One

We would suggest creating a new one if you haven’t done so.

![img](https://miro.medium.com/max/700/0*zD30bGiLp1uGj__x.png)
...
![img](https://miro.medium.com/max/700/1*pAbeUPBFtsduY2aCYlieTg.png)

Once Connected, search for Syscoin in the search bar.

![img](https://miro.medium.com/max/700/1*_n1fk23nelHG51WhAiqLBw.png)
...
![img](https://miro.medium.com/max/439/0*hV4A6KSJcf4jJaNm.png)

Scroll down until you find Custom RPC.



![img](https://miro.medium.com/max/324/0*oaCbe1yUZKE7Cs_2.png)
...
- **Chain ID:** 57
- **Currency Symbol:** SYS
- **Block Explorer URL:** [https://nevm.syscoin.org](https://nevm.syscoin.org)
