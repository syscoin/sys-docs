...
## EACH MASTERNODE MUST HAVE THE FOLLOWING

**1. A brand new VPS to install**
**2. A Seperate BLS Key per node.**
**3. An Owner and Voting Key**
...
[Masternode Install Guide 88](https://www.youtube.com/watch?v=pOwcFMP92hY)
...
- [UK2.net 15](https://uk2.net/)
- [IONOS.co.uk 2](https://ionos.co.uk/)
- [InterServer.net 3](https://interserver.net/)
- [OVH.co.uk 2](https://ovh.co.uk/)
- [KimSufi.com 2](https://kimsufi.com/)
- [mVPS.net 4](https://mvps.net/)
- [VPS-Mart.com 5](https://vps-mart.com/)
- [Hostinger.com 4](https://hostinger.com/)
- [BudgetVM.com 4](https://budgetvm.com/)
- [Virtono.com 4](https://virtono.com/)
- [LeaseWeb.com 3](https://leaseweb.com/)
- [HomeAtCloud.com 5](https://homeatcloud.com/)
- [IdeaStack.com 6](https://ideastack.com/)
- [SSDNodes.com 7](https://ssdnodes.com/)
- [SimplyHosting.com 3](https://simplyhosting.com/)
- [RAMNode.com 6](https://ramnode.com/)
- [Time4VPS.com 7](https://time4vps.com/)

## MASTERNODE HELP

[Syscoin Discord 14](https://discord.gg/RkK2AXD): If you require more help, jump into the Syscoin Discord and our community will be more than happy to help you out!

[Sysnode.info 12](https://sysnode.info/): This website has an array of tools such as Masternode Stats, Monitoring and keeping up to date with current news with Syscoin.
...
> **Please also check the latest releases - if it is not 4.3.0, you will need to enter in the latest release tag for for Syscoin Core Github Branch. So if the latest release is 4.3.1, you would enter 4.3.1 and then press enter. You can check that here; [Releases · syscoin/syscoin · GitHub 11](https://github.com/syscoin/syscoin/releases)**

Default values are found in brackets and pressing enter will selected the [default] value. For entries with a [Y/n] the capital letter is the default. Enter [Y] to choose “yes” or [N] to choose “no”. Likely the only value you will need to enter is the latest release tag and Masternode BLS Secret key.
...
Open a text editor such as notepad ++ to prepare this command or head to [SysHub Masternode Registration 44](https://syshub-dev.web.app/masternodes/masternode-registration).
